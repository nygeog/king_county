...
dir_loc = r'W:\GIS\Projects\king_county\data'
pts = r'W:\GIS\Projects\king_county\data\processing\nets_king_county.gdb\king_county_pts'
dir_out = r'W:\GIS\Projects\king_county\data\processing\intersects.gdb'

print "create xy event layer - OLD NOTES now fixed: note that x and y in stata file are reversed - so switch if updated"
arcpy.MakeXYEventLayer_management(dir_loc+"/processing/nets_king_county.gdb/kingcounty_finalxy_flag","final_x","final_y","king_county_table_layer","GEOGCS['GCS_WGS_1984',DATUM['D_WGS_1984',SPHEROID['WGS_1984',6378137.0,298.257223563]],PRIMEM['Greenwich',0.0],UNIT['Degree',0.0174532925199433]];-400 -400 1000000000;-100000 10000;-100000 10000;8.98315284119522E-09;0.001;0.001;IsHighPrecision","#")
...
arcpy.XToolsGP_Export2Text(dir_loc+"/processing/intersects.gdb/king_county_tract_1990_sp","BEH_ID;g_ct1990",dir_loc+"/processing/tables/census_geographies/ct1990.txt")
arcpy.XToolsGP_Export2Text(dir_loc+"/processing/intersects.gdb/king_county_tract_2000_sp","BEH_ID;g_ct2000",dir_loc+"/processing/tables/census_geographies/ct2000.txt")
arcpy.XToolsGP_Export2Text(dir_loc+"/processing/intersects.gdb/king_county_tract_2010_sp","BEH_ID;g_ct2010",dir_loc+"/processing/tables/census_geographies/ct2010.txt")
arcpy.XToolsGP_Export2Text(dir_loc+"/processing/intersects.gdb/king_county_zcta_2000_sp", "BEH_ID;g_zt2000",dir_loc+"/processing/tables/census_geographies/zt2000.txt")
arcpy.XToolsGP_Export2Text(dir_loc+"/processing/intersects.gdb/king_county_zcta_2010_sp", "BEH_ID;g_zt2010",dir_loc+"/processing/tables/census_geographies/zt2010.txt")
